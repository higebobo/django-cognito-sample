...
# cognito
COGNITO_USER_MODEL_FIELD_REF_FIELD = os.getenv('COGNITO_USER_MODEL_FIELD_REF_FIELD', 'sub')
COGNITO_TOKEN_REF_FIELD = os.getenv('COGNITO_TOKEN_REF_FIELD', 'sub')

# cognito user pool
APP_CLIENT_ID = os.getenv('APP_CLIENT_ID', 'client_id')
APP_SECRET_KEY = os.getenv('APP_SECRET_KEY', 'client_secret')
